...
public class LMSBookPersistenceImpl extends BasePersistenceImpl<LMSBook>
	 ...
	 *
	 * @param lMSBookId the primary key for the new l m s book
	 * @return the new l m s book
	 */
	public LMSBook create(long lMSBookId) {
		LMSBook lmsBook = new LMSBookImpl();

		lmsBook.setNew(true);
		lmsBook.setPrimaryKey(lMSBookId);
	 ...
	 *
	 * @param lMSBookId the primary key of the l m s book
	 ...
	 */
	public LMSBook remove(long lMSBookId)
		throws NoSuchLMSBookException, SystemException {
		return remove(Long.valueOf(lMSBookId));
	}
	...
	protected LMSBook toUnwrappedModel(LMSBook lmsBook) {
		...
		lmsBookImpl.setLMSBookId(lmsBook.getLMSBookId());
		...
		lmsBookImpl.setBookAuthor(lmsBook.getBookAuthor());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LMSBook findByPrimaryKey(long lMSBookId)
		throws NoSuchLMSBookException, SystemException {
		LMSBook lmsBook = fetchByPrimaryKey(lMSBookId);

		if (lmsBook == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + lMSBookId);
			}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LMSBook fetchByPrimaryKey(long lMSBookId) throws SystemException {
		LMSBook lmsBook = (LMSBook)EntityCacheUtil.getResult(LMSBookModelImpl.ENTITY_CACHE_ENABLED,
				LMSBookImpl.class, lMSBookId);
		...
		if (lmsBook == null) {
			...
			try {
				...
				if (lmsBook != null) {
					...
					EntityCacheUtil.putResult(LMSBookModelImpl.ENTITY_CACHE_ENABLED,
						LMSBookImpl.class, lMSBookId, _nullLMSBook);
				}
